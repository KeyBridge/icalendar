...
/**
 * A utility class listing some leap years and generating a large number of
 * LocalDateTimes for testing purposes.
 *
...
class DateTestUtil {
  ...
  /**
   * Generate a stream of LocalDateTime instances starting at midnight on
   * 1970-01-01 at every 30 seconds until the end of that year.
   *
