...
//    }
    Event s = Event.getInstance(
      ZonedDateTime.now(),
      ZonedDateTime.now().plus(4, HOURS)
    );
...
//        System.out.println("  Znow local " + utcLocal);
  ...
  public void testDuration() {
    Event s = Event.getInstance(ZonedDateTime.now(), HOURS, 48);
  ...
  public void testSort() throws Exception {
    Event scheduleMain = Event.getInstance(ZonedDateTime.of(LocalDateTime.of(2017, 1, 12, 12, 0, 0), ZoneId.systemDefault()), DAYS, 2);
    System.out.println("  Event MAIN   : " + scheduleMain);

    /**
     * A four hour schedule on Jan 06.
     */
    Event srecur = Event.getInstance(LocalDateTime.of(2017, 1, 6, 10, 0, 0), HOURS, 4);
...
//    for (Event schedule : srecur.calculatePeriodList(scheduleMain.getDateStart(), scheduleMain.getDateEnd())) {      System.out.println("    period intercept " + schedule);    }
    ...
    schedules.add(Event.getInstance(LocalDateTime.of(2017, 1, 3, 6, 0, 0), DAYS, 2));
    schedules.add(Event.getInstance(LocalDateTime.of(2017, 1, 4, 6, 0, 0), DAYS, 2));
...
//    srecur.setRrule("FREQ=WEEKLY;INTERVAL=1;");
     ...
     */
    assertEquals(10, periodSet.size());
  }
  ...
  public void testIntersection2() {
    ...
    time2 = time1.plus(1, DAYS);
    schedule1 = Event.getInstance(time1, time2);
    schedule2 = Event.getInstance(time1, time2);
    assertTrue(Event.intersect(schedule1, schedule2));
    assertTrue(schedule1.intersects(schedule2));
    assertTrue(schedule2.intersects(schedule1));
    assertTrue(schedule1.contains(schedule2));
    assertTrue(schedule2.contains(schedule1));
    ...
    time2 = time1.plus(1, DAYS);
    schedule1 = Event.getInstance(time1, time2);
    schedule2 = Event.getInstance(time1.plus(1, HOURS), time2);
    assertTrue(Event.intersect(schedule1, schedule2));
    assertTrue(schedule1.intersects(schedule2));
    assertTrue(schedule2.intersects(schedule1));
    assertTrue(schedule1.contains(schedule2));
    assertFalse(schedule2.contains(schedule1));
    ...
    time2 = time1.plus(1, DAYS);
    schedule1 = Event.getInstance(time1, time2);
    schedule2 = Event.getInstance(time1, time2.minus(1, HOURS));
    assertTrue(Event.intersect(schedule1, schedule2));
    assertTrue(schedule1.intersects(schedule2));
    assertTrue(schedule2.intersects(schedule1));
    assertTrue(schedule1.contains(schedule2));
    ...
    time2 = time1.plus(1, DAYS);
    schedule1 = Event.getInstance(time1, time2);
    schedule2 = Event.getInstance(time1.plus(1, HOURS), time2.minus(1, HOURS));
    assertTrue(Event.intersect(schedule1, schedule2));
    assertTrue(schedule1.intersects(schedule2));
    assertTrue(schedule2.intersects(schedule1));
    assertTrue(schedule1.contains(schedule2));
    ...
    time1 = ZonedDateTime.now();
    time2 = time1.plus(1, DAYS);
    schedule1 = Event.getInstance(time1.plus(1, HOURS), time2.minus(1, HOURS));
    schedule2 = Event.getInstance(time1, time2);
    assertTrue(Event.intersect(schedule1, schedule2));
    assertTrue(schedule1.intersects(schedule2));
    assertTrue(schedule2.intersects(schedule1));
    assertFalse(schedule1.contains(schedule2));
    assertTrue(schedule2.contains(schedule1));
    ...
    time2 = time1.plus(1, DAYS);
    schedule1 = Event.getInstance(time1, time2);
    schedule2 = Event.getInstance(time1.minus(1, HOURS), time2.minus(1, HOURS));
    assertTrue(Event.intersect(schedule1, schedule2));
    assertTrue(schedule1.intersects(schedule2));
    assertTrue(schedule2.intersects(schedule1));
    assertFalse(schedule1.contains(schedule2));
    ...
    time2 = time1.plus(1, DAYS);
    schedule1 = Event.getInstance(time1, time2);
    schedule2 = Event.getInstance(time1.plus(1, HOURS), time2.plus(1, HOURS));
    assertTrue(Event.intersect(schedule1, schedule2));
    assertTrue(schedule1.intersects(schedule2));
    assertTrue(schedule2.intersects(schedule1));
    assertFalse(schedule1.contains(schedule2));
     ...
     */
    schedule2 = Event.getInstance(time1.plus(1, MILLENNIA), time2.plus(1, MILLENNIA));
    assertFalse(Event.intersect(schedule1, schedule2));
    assertFalse(schedule1.intersects(schedule2));
    assertFalse(schedule2.intersects(schedule1));
    assertFalse(schedule1.contains(schedule2));
    assertFalse(schedule2.contains(schedule1));
     ...
     * a.contains(b): false b.contains(a): false
     */
    schedule2 = Event.getInstance(time1.minus(1, MILLENNIA), time2.minus(1, MILLENNIA));
    assertFalse(Event.intersect(schedule1, schedule2));
    assertFalse(schedule1.intersects(schedule2));
    assertFalse(schedule2.intersects(schedule1));
    assertFalse(schedule1.contains(schedule2));
  ...
  public void testIntersectionConcept() throws Exception {
    ...
    Event s = Event.getInstance(start, DAYS, 3);
//    s.setRecur(new RecurType("FREQ=WEEKLY;INTERVAL=1;BYDAY=MO,TU,TH"));
    ...
    ZonedDateTime tstart = ZonedDateTime.now().withMinute(0).minus(1, DAYS);
    ZonedDateTime tend = ZonedDateTime.now().plus(1, DAYS);
//    end.add(Calendar.DAY_OF_YEAR, 1);
    ...
    assertFalse(s.intersects(tstart));
...
//    Calendar sstart = Calendar.getInstance();    sstart.set(Calendar.HOUR_OF_DAY, 9);    sstart.set(Calendar.MINUTE, 0);
    Event s = Event.getInstance(ZonedDateTime.now().withHour(9).withMinute(0), HOURS, 3);
...
//    tstart.add(Calendar.DAY_OF_YEAR, 14);
    ...
    Event t = Event.getInstance(tstart, HOURS, 48);
  ...
  public void testPeriodList() throws Exception {
    ...
    assertFalse(s.calculatePeriodList(s.getDateStart(), s.getDateExpire()).isEmpty());
  ...
  public void testRec() throws Exception {
    ...
    final Event schedule = Event.getInstance(ZonedDateTime.of(dateStart, timeZone), HOURS, 2);
    ...
    assertTrue(schedule.intersects(Event.getInstance(
      ZonedDateTime.of(LocalDateTime.of(2017, 9, 21, 14, 0, 0), timeZone),
      HOURS, 2)));
    assertTrue(schedule.intersects(Event.getInstance(
      ZonedDateTime.of(LocalDateTime.of(2017, 9, 21, 14, 0, 0), timeZone),
      HOURS, 1)));
    assertFalse(schedule.intersects(Event.getInstance(
      ZonedDateTime.of(LocalDateTime.of(2017, 9, 21, 14, 0, 0), timeZone),
      MINUTES, 59)));
    assertTrue(schedule.intersects(Event.getInstance(
      ZonedDateTime.of(LocalDateTime.of(2017, 9, 21, 15, 0, 0), timeZone),
    ...
    test = Event.getInstance(
      ...
      MINUTES, 30);
    assertFalse(schedule.intersects(test));
  }
  ...
  public void testPeriodListX() throws Exception {
    LocalDateTime eventStart = LocalDateTime.of(2017, 9, 1, 9, 0, 0),
      eventEnd = eventStart.plus(2, HOURS),
      periodStart = eventStart,
      periodEnd = eventStart.plus(1, YEARS);
    ...
    testEveryEventInSet(periods, periodEnd, new PeriodType(eventStart, eventEnd), 1, WEEKS);

    periods = ICalendar.calculatePeriodSet(eventStart, eventEnd, new RecurType("FREQ=MONTHLY;INTERVAL=1"), periodStart, periodEnd);
    assertTrue(!periods.isEmpty());
    testEveryEventInSet(periods, periodEnd, new PeriodType(eventStart, eventEnd), 1, MONTHS);
    ...
    testEveryEventInSet(periods, periodEnd, new PeriodType(eventStart.plus(2, DAYS), eventEnd.plus(2, DAYS)), 1, WEEKS);

    periods = ICalendar.calculatePeriodSet(eventStart, eventEnd, new RecurType("FREQ=DAILY;INTERVAL=1"), periodStart, periodEnd);
    assertTrue(!periods.isEmpty());
    testEveryEventInSet(periods, periodEnd, new PeriodType(eventStart, eventEnd), 1, DAYS);

    periods = ICalendar.calculatePeriodSet(eventStart, eventEnd, new RecurType("FREQ=HOURLY;INTERVAL=1"), periodStart, periodEnd);
    assertTrue(!periods.isEmpty());
    testEveryEventInSet(periods, periodEnd, new PeriodType(eventStart, eventEnd), 1, HOURS);
  ...
  public static void testEveryEventInSet(Set<PeriodType> periodsToTest, LocalDateTime periodEnd, PeriodType firstEvent, int interval, TemporalUnit temporalUnit) {
    ...
    while (testDate.compareTo(periodEnd) <= 0) {
      count++;
      assertTrue(periodsToTest.contains(new PeriodType(testDate, testDate.plus(eventLength))));
      testDate = testDate.plus(interval, temporalUnit);
    }
    assertEquals(count, periodsToTest.size());
  }
  ...
  public void testByDayAndMinute() throws Exception {
    LocalDateTime eventStart = LocalDateTime.of(2017, 9, 1, 9, 0, 0),
      eventEnd = eventStart.plus(2, HOURS),
      periodStart = eventStart,
      periodEnd = periodStart.plus(1, WEEKS);
    ...
    assertTrue(periods.contains(new PeriodType(eventStart, eventEnd)));
    // check if the Sunday (+2 days from Friday) event is in the set
    assertTrue(periods.contains(new PeriodType(eventStart.plus(2, DAYS), eventEnd.plus(2, DAYS))));
    assertTrue(periods.contains(new PeriodType(eventStart.plus(3, DAYS), eventEnd.plus(3, DAYS))));
    assertTrue(periods.contains(new PeriodType(eventStart.plus(4, DAYS), eventEnd.plus(4, DAYS))));
    assertTrue(periods.contains(new PeriodType(eventStart.plus(6, DAYS), eventEnd.plus(6, DAYS))));
    ...
    assertTrue(periods.contains(
      new PeriodType(
        eventStart.plus(2, DAYS).withHour(12),
        eventStart.plus(2, DAYS).withHour(14))));
    assertTrue(periods.contains(
      new PeriodType(
        eventStart.plus(2, DAYS).withHour(16),
        eventStart.plus(2, DAYS).withHour(18))));

    assertTrue(periods.contains(
      new PeriodType(
        eventStart.plus(3, DAYS).withHour(12),
        eventStart.plus(3, DAYS).withHour(14))));
    assertTrue(periods.contains(
      new PeriodType(
        eventStart.plus(3, DAYS).withHour(16),
        eventStart.plus(3, DAYS).withHour(18))));

    assertTrue(periods.contains(
      new PeriodType(
        eventStart.plus(4, DAYS).withHour(12),
        eventStart.plus(4, DAYS).withHour(14))));
    assertTrue(periods.contains(
      new PeriodType(
        eventStart.plus(4, DAYS).withHour(16),
        eventStart.plus(4, DAYS).withHour(18))));

    assertTrue(periods.contains(
      new PeriodType(
        eventStart.plus(6, DAYS).withHour(12),
        eventStart.plus(6, DAYS).withHour(14))));
    assertTrue(periods.contains(
      new PeriodType(
        eventStart.plus(6, DAYS).withHour(16),
        eventStart.plus(6, DAYS).withHour(18))));

    eventStart = LocalDateTime.of(2017, 9, 1, 9, 0, 0);
    eventEnd = eventStart.plus(2, HOURS);
    periodStart = eventStart;
    periodEnd = periodStart.plus(6, DAYS);
    ...
    eventStart = LocalDateTime.of(2017, 9, 1, 9, 0, 0);
    eventEnd = eventStart.plus(2, HOURS);
    periodStart = eventStart.minus(2, HOURS);
    periodEnd = periodStart.plus(1, WEEKS);
  ...
  public void testByTemporalUnit() throws Exception {
    LocalDateTime eventStart = LocalDateTime.of(2017, 1, 1, 7, 0, 0),
      eventEnd = eventStart.plus(1, MINUTES),
      periodStart = eventStart,
      periodEnd = periodStart.plus(50, YEARS);
...
//    periods.forEach(System.out::println);
    periods.remove(new PeriodType(eventStart, eventEnd));
    testEveryEventInSet(periods, periodEnd, new PeriodType(eventStart.withDayOfYear(20), eventEnd.withDayOfYear(20)), 1, YEARS);

    // BYYEARDAY (negative)
    periods = ICalendar.calculatePeriodSet(eventStart, eventEnd, new RecurType("FREQ=YEARLY;INTERVAL=1;BYYEARDAY=-5"), periodStart.minus(10, DAYS), periodEnd);
//    periods.forEach(System.out::println);
    periods.remove(new PeriodType(eventStart, eventEnd));
    // the fifth last day of the year is always the 26 of December.
    testEveryEventInSet(periods, periodEnd, new PeriodType(eventStart.withMonth(12).withDayOfMonth(26), eventEnd.withMonth(12).withDayOfMonth(26)), 1, YEARS);
...
//    periods.forEach(System.out::println);
    ...
    assertEquals(101, periods.size());
    // All periods should happen in January
    assertTrue(periods.stream().allMatch(period -> period.getStart().getMonth().equals(Month.JANUARY)));
...
//    periods.forEach(System.out::println);
    ...
    assertTrue(periods.stream().allMatch(period -> period.getStart().getMonth().equals(Month.DECEMBER)));
...
//    periods.forEach(System.out::println);
    ...
    assertTrue(periods.stream().allMatch(period -> period.getStart().getMonth().equals(Month.FEBRUARY) || period.getStart().getMonth().equals(Month.APRIL)));
...
//    periods.forEach(System.out::println);
    ...
    periods.remove(new PeriodType(eventStart, eventEnd));
    // All periods should happen in January or February
    assertTrue(periods.stream().allMatch(period -> period.getStart().getMonth().equals(Month.OCTOBER) || period.getStart().getMonth().equals(Month.AUGUST)));

    // BYMONTHDAY
    periodEnd = periodStart.plus(2, YEARS);
...
//    periods.forEach(System.out::println);
    ...
    assertEquals(49, periods.size());
    periods.remove(new PeriodType(eventStart, eventEnd));
    assertTrue(periods.stream().allMatch(period -> period.getStart().getDayOfMonth() == 2 || period.getStart().getDayOfMonth() == 4));
...
//    periods.forEach(System.out::println);
    assertEquals(25, periods.size());
    periods.remove(new PeriodType(eventStart, eventEnd));
    assertTrue(periods.stream().allMatch(period -> Arrays.asList(26, 27, 28, 29).contains(period.getStart().getDayOfMonth())));
...
//    periods.forEach(System.out::println);
    periods.remove(new PeriodType(eventStart, eventEnd));
    assertTrue(periods.stream().allMatch(period -> Arrays.asList(DayOfWeek.MONDAY, DayOfWeek.TUESDAY).contains(period.getStart().getDayOfWeek())));
...
//    periods.forEach(System.out::println);
    periods.remove(new PeriodType(eventStart, eventEnd));
    assertTrue(periods.stream().allMatch(period -> Arrays.asList(DayOfWeek.MONDAY, DayOfWeek.TUESDAY).contains(period.getStart().getDayOfWeek())));
    assertTrue(periods.stream().map(PeriodType::getStart).allMatch(date -> date.get(WeekFields.of(DayOfWeek.SUNDAY, 4).weekOfMonth()) <= 3));
...
//    periods.forEach(System.out::println);
    periods.remove(new PeriodType(eventStart, eventEnd));
    assertTrue(periods.stream().map(PeriodType::getStart).allMatch(date -> date.getDayOfWeek() == DayOfWeek.FRIDAY));
...
//        .forEach(System.out::println);
    ...
    // BYHOUR
    periodEnd = periodStart.plus(2, MONTHS);
...
//    periods.forEach(System.out::println);
    periods.remove(new PeriodType(eventStart, eventEnd));
    assertTrue(periods.stream().allMatch(period -> Arrays.asList(14, 16).contains(period.getStart().getHour())));
...
//    periods.forEach(System.out::println);
    ...
    // BYMINUTE
    periodEnd = periodStart.plus(2, DAYS);
...
//    periods.forEach(System.out::println);
    periods.remove(new PeriodType(eventStart, eventEnd));
    assertTrue(periods.stream().allMatch(period -> Arrays.asList(10, 30).contains(period.getStart().getMinute())));
...
//    periods.forEach(System.out::println);
    ...
    // BYSECOND
    periodEnd = periodStart.plus(2, HOURS);
...
//    periods.forEach(System.out::println);
    periods.remove(new PeriodType(eventStart, eventEnd));
    assertTrue(periods.stream().allMatch(period -> Arrays.asList(10, 30).contains(period.getStart().getSecond())));
...
//    periods.forEach(System.out::println);
    assertEquals(50, periods.size()); // two events every two years
    periods.remove(new PeriodType(eventStart, eventEnd));
    // All periods should happen in January
    assertTrue(periods.stream().allMatch(period -> period.getStart().getMonth().equals(Month.JANUARY)));
    assertTrue(periods.stream().allMatch(period -> Arrays.asList(8, 9).contains(period.getStart().getHour())));
    assertTrue(periods.stream().allMatch(period -> period.getStart().getMinute() == 30));
  }

  @Test
  public void testLimitByTemporalUnit() throws Exception {
    LocalDateTime eventStart = LocalDateTime.of(2017, 1, 1, 7, 0, 0),
      eventEnd = eventStart.plus(1, SECONDS),
      periodStart = eventStart,
      periodEnd = periodStart.plus(2, MINUTES);
...
//    periods.forEach(System.out::println);
    assertEquals(5, periods.size());
    assertTrue(periods.contains(originalEvent));
    assertTrue(periods.contains(new PeriodType(eventStart.plusSeconds(2), duration)));
    assertTrue(periods.contains(new PeriodType(eventStart.plusSeconds(4), duration)));
    assertTrue(periods.contains(new PeriodType(eventStart.plusSeconds(2).plusMinutes(1), duration)));
    assertTrue(periods.contains(new PeriodType(eventStart.plusSeconds(4).plusMinutes(1), duration)));
...
//    periods.forEach(System.out::println);
    assertEquals(5, periods.size());
    assertTrue(periods.contains(originalEvent));
    assertTrue(periods.contains(new PeriodType(eventStart.plusSeconds(56), duration)));
    assertTrue(periods.contains(new PeriodType(eventStart.plusSeconds(58), duration)));
    assertTrue(periods.contains(new PeriodType(eventStart.plusSeconds(56).plusMinutes(1), duration)));
    assertTrue(periods.contains(new PeriodType(eventStart.plusSeconds(58).plusMinutes(1), duration)));
...
//    periods.forEach(System.out::println);
    ...
    periods = ICalendar.calculatePeriodSet(eventStart, eventEnd, new RecurType("FREQ=MINUTELY;INTERVAL=2;BYMINUTE=2,-4"),
                                           eventStart, eventStart.plus(2, HOURS));
//    periods.forEach(System.out::println);
    assertEquals(5, periods.size());
    assertTrue(periods.contains(originalEvent));
    assertTrue(periods.contains(new PeriodType(eventStart.plusMinutes(2), duration)));
    assertTrue(periods.contains(new PeriodType(eventStart.plusMinutes(56), duration)));
    assertTrue(periods.contains(new PeriodType(eventStart.plusMinutes(2).plusHours(1), duration)));
    assertTrue(periods.contains(new PeriodType(eventStart.plusMinutes(56).plusHours(1), duration)));

    periods = ICalendar.calculatePeriodSet(eventStart, eventEnd, new RecurType("FREQ=HOURLY;INTERVAL=1;BYHOUR=12,-3"),
                                           eventStart, eventStart.plus(1, DAYS));
//    periods.forEach(System.out::println);
    assertEquals(3, periods.size());
    assertTrue(periods.contains(originalEvent));
    assertTrue(periods.contains(new PeriodType(eventStart.withHour(12), duration)));
    assertTrue(periods.contains(new PeriodType(eventStart.withHour(21), duration)));
    ...
    periods = ICalendar.calculatePeriodSet(eventStart, eventStart.plus(duration),
                                           ...
                                           eventStart, eventStart.plus(2, MONTHS));
//    periods.forEach(System.out::println);
    assertEquals(17, periods.size());
    ...
    assertTrue(periods.contains(periodType));
    periods.remove(originalEvent);
    assertTrue(periods.stream().map(PeriodType::getStart).allMatch(d -> d.getSecond() == 5 || d.getSecond() == 7));
    assertTrue(periods.stream().map(PeriodType::getStart).allMatch(d -> d.getMinute() == 10 || d.getMinute() == 50));
    assertTrue(periods.stream().map(PeriodType::getStart).allMatch(d -> d.getHour() == 16 || d.getHour() == 20));
    assertTrue(periods.stream().map(PeriodType::getStart).allMatch(d -> d.getDayOfMonth() == 16 || d.getDayOfMonth() == 9));
    assertTrue(periods.stream().map(PeriodType::getStart).allMatch(d -> d.getMonthValue() == 9 || d.getMonthValue() == 10));
...
//    periods.forEach(System.out::println);
    ...
    assertTrue(periods.containsAll(periods2) && periods2.containsAll(periods));
...
//    periods.forEach(System.out::println);
    assertEquals(3 * 31, periods.size());
  }
  ...
  public void testLimitRuleExceptions() throws Exception {
    ...
    Set<PeriodType> periods = ICalendar.calculatePeriodSet(eventStart, eventStart.plus(duration),
                                                           ...
                                                           eventStart, eventStart.with(TemporalAdjusters.lastDayOfYear()));
//    periods.forEach(System.out::println);
    assertEquals(Year.from(eventStart).length(), periods.size());
    /**
...
//  @Test
  public void testRuleEquivalence() throws Exception {
    ...
    Set<PeriodType> periods = ICalendar.calculatePeriodSet(eventStart, eventEnd,
                                                           ...
                                                           periodStart, periodStart.plus(2, DAYS));
//    periods.forEach(System.out::println);
