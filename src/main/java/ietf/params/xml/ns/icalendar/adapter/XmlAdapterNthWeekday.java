...
public class XmlAdapterNthWeekday extends XmlAdapter<String, NthWeekdayRecurType> {
   ...
   * @return an NthWeekdayRecurType instance if input string valid, null otherwise
   */
  @Override
  ...
  /**
   * Convert an NthWeekdayRecurType instance to an BYDAY RRULE string, such as 1MO, TU, -2FR
