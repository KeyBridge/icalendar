 ...
 */
public class XmlAdapterLocalDateXCalDate extends XmlAdapter<String, LocalDate> {

  /**
   * Unmarshal a string xCal DATE into a java.time.LocalDate instance.
   * <p>
  ...
  public LocalDate unmarshal(String v) throws DateTimeParseException {
    ...
    for (DateTimeFormatter formatter : Arrays.asList(Constants.FORMATTER_RFC6321_DATE, Constants.FORMATTER_RFC5545_DATE)) {
      try {
