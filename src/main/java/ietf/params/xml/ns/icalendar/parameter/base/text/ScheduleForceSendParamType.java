...
/**
 * scheduleforcesendparam = "SCHEDULE-FORCE-SEND" "=" ("REQUEST" ; Force a
 * "REQUEST" / "REPLY" ; Force a "REPLY" / iana-token) ; IANA registered method
 * <p>
 * Java class for ScheduleForceSendParamType complex type. The following schema
 * fragment specifies the expected content contained within this class.
 * <pre>  &lt;complexType name="ScheduleForceSendParamType"&gt; &lt;complexContent&gt;
